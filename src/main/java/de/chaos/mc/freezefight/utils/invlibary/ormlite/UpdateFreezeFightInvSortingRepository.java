...
public class UpdateFreezeFightInvSortingRepository implements UpdateFreezeFightInventorySortingInterface {
    ...
    public void checkIfFirstJoin(UUID uuid) {
        ...
        try {
            if (getInventory(uuid) == null) {
                FreezeFightInvSortingDAO = de.chaos.mc.freezefight.utils.invlibary.ormlite.FreezeFightInvSortingDAO.builder()
                        .uuid(uuid)
                        .swordSlot(0)
                        .bowSlot(1)
                        .eggSlot(2)
    ...
    public void updateSorting(Player player, Inventory inventory) {
        ...
        FreezeFightInvSortingDAO FreezeFightInvSortingDAO = de.chaos.mc.freezefight.utils.invlibary.ormlite.FreezeFightInvSortingDAO.builder()
