...
import de.chaos.mc.freezefight.utils.invlibary.ormlite.FreezeFightInvSortingDAO;
...
public class SortingInv {
    private final UpdateFreezeFightInventorySortingInterface invInterface;
    private final LanguageInterface languageInterface;

    public SortingInv(UpdateFreezeFightInventorySortingInterface updateInventorySortingInterface, LanguageInterface languageInterface) {
